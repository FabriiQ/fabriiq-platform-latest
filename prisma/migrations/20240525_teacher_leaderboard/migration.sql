...
ALTER TABLE "teacher_profiles" ADD COLUMN "totalPoints" INTEGER NOT NULL DEFAULT 0;
CREATE INDEX "teacher_profiles_totalPoints_idx" ON "teacher_profiles"("totalPoints");
...
CREATE TABLE "teacher_points_aggregate" (
    "id" TEXT NOT NULL,
    "teacherId" TEXT NOT NULL,
    "classId" TEXT,
    "subjectId" TEXT,
...
CREATE INDEX "teacher_points_teacherId_idx" ON "teacher_points"("teacherId");
CREATE INDEX "teacher_points_classId_idx" ON "teacher_points"("classId");
CREATE INDEX "teacher_points_subjectId_idx" ON "teacher_points"("subjectId");
CREATE INDEX "teacher_points_source_idx" ON "teacher_points"("source");
CREATE INDEX "teacher_points_createdAt_idx" ON "teacher_points"("createdAt");
CREATE INDEX "teacher_points_status_idx" ON "teacher_points"("status");
CREATE INDEX "teacher_points_partitionKey_idx" ON "teacher_points"("partitionKey");

-- Create indexes for TeacherPointsAggregate
CREATE INDEX "teacher_points_aggregate_teacherId_idx" ON "teacher_points_aggregate"("teacherId");
CREATE INDEX "teacher_points_aggregate_classId_idx" ON "teacher_points_aggregate"("classId");
CREATE INDEX "teacher_points_aggregate_subjectId_idx" ON "teacher_points_aggregate"("subjectId");
CREATE INDEX "teacher_points_aggregate_courseId_idx" ON "teacher_points_aggregate"("courseId");
CREATE INDEX "teacher_points_aggregate_programId_idx" ON "teacher_points_aggregate"("programId");
CREATE INDEX "teacher_points_aggregate_campusId_idx" ON "teacher_points_aggregate"("campusId");
CREATE INDEX "teacher_points_aggregate_date_idx" ON "teacher_points_aggregate"("date");
CREATE INDEX "teacher_points_aggregate_status_idx" ON "teacher_points_aggregate"("status");
CREATE INDEX "teacher_points_aggregate_partitionKey_idx" ON "teacher_points_aggregate"("partitionKey");

-- Create indexes for TeacherAchievement
CREATE INDEX "teacher_achievements_teacherId_idx" ON "teacher_achievements"("teacherId");
CREATE INDEX "teacher_achievements_type_idx" ON "teacher_achievements"("type");
CREATE INDEX "teacher_achievements_unlocked_idx" ON "teacher_achievements"("unlocked");
CREATE INDEX "teacher_achievements_status_idx" ON "teacher_achievements"("status");
CREATE INDEX "teacher_achievements_partitionKey_idx" ON "teacher_achievements"("partitionKey");

-- Create indexes for TeacherPerformanceMetrics
CREATE INDEX "teacher_performance_metrics_teacherId_idx" ON "teacher_performance_metrics"("teacherId");
CREATE INDEX "teacher_performance_metrics_classId_idx" ON "teacher_performance_metrics"("classId");
CREATE INDEX "teacher_performance_metrics_subjectId_idx" ON "teacher_performance_metrics"("subjectId");
CREATE INDEX "teacher_performance_metrics_courseId_idx" ON "teacher_performance_metrics"("courseId");
CREATE INDEX "teacher_performance_metrics_programId_idx" ON "teacher_performance_metrics"("programId");
CREATE INDEX "teacher_performance_metrics_timeframe_idx" ON "teacher_performance_metrics"("timeframe");
CREATE INDEX "teacher_performance_metrics_date_idx" ON "teacher_performance_metrics"("date");
CREATE INDEX "teacher_performance_metrics_status_idx" ON "teacher_performance_metrics"("status");
CREATE INDEX "teacher_performance_metrics_partitionKey_idx" ON "teacher_performance_metrics"("partitionKey");
