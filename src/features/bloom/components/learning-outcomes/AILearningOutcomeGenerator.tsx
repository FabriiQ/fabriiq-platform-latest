...
export function AILearningOutcomeGenerator({
  subjectId,
  topicId,
  onSelect,
}: AILearningOutcomeGeneratorProps) {
    ...
    <>
      <Card className="p-4 border-dashed border-2 border-gray-300 bg-gray-50 dark:bg-gray-800">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-lg font-medium text-primary-green">AI-Assisted Learning Outcomes</h3>
        </div>

        <div className="space-y-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Use AI to generate learning outcomes aligned with Bloom's Taxonomy levels. You can generate outcomes for a single level or multiple levels at once.
          </p>
