          ...
          <CardContent className="p-6">
            <div className="flex flex-col items-center text-center">
              ...
              <ul className="mt-4 text-sm text-left space-y-2">
                ...
                <li className="flex items-start">
                  <span className="text-primary mr-2">✓</span>
                  <span>Customize and refine the generated content</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-2">✓</span>
                  <span>Get inspiration and ideas</span>
                </li>
              </ul>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col items-center text-center">
              ...
              <ul className="mt-4 text-sm text-left space-y-2">
                ...
                <li className="flex items-start">
                  <span className="text-primary mr-2">✓</span>
                  <span>Use existing templates and components</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-2">✓</span>
                  <span>Perfect for specific or complex content</span>
                </li>
              </ul>
            </div>
          </CardContent>
