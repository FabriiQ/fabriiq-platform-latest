...
import { QuestionGenerationRequest, GeneratedQuestion } from '../services/ai-question-generator.service';
import { api } from '@/trpc/react';

interface AIQuestionGeneratorButtonProps {
  // Context data that will be pre-filled
...
export function AIQuestionGeneratorButton({
  selectedTopics = [],
  ...
  // tRPC mutation for generating questions
  const generateQuestionsMutation = api.aiQuestionGenerator.generateQuestions.useMutation();
  ...
  const handleGenerateQuestions = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Successfully generated ${response.questions.length} questions in ${response.metadata.generationTime}ms`,
      });
        ...
        <CollapsibleContent className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Generate questions based on your selected topics, learning outcomes, and Bloom's taxonomy level
              </CardDescription>
            </CardHeader>
