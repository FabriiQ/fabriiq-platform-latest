        ...
        return await ProcedureCacheHelpers.cacheUserNotifications(
          ...
          async () => {
            ...
            return notifications.map(notification => ({
              ...notification,
              // Normalize type to client enum values when possible
              type: (notification.type === 'SOCIAL_WALL_POST' ? 'SOCIAL_POST'
                : notification.type === 'SOCIAL_WALL_COMMENT' ? 'SOCIAL_COMMENT'
                : notification.type === 'SOCIAL_WALL_REACTION' ? 'SOCIAL_REACTION'
                : notification.type === 'SOCIAL_WALL_MENTION' ? 'SOCIAL_MENTION'
