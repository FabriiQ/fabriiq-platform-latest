...
/**
 * Select component with mobile-first design
 * 
 * Features:
 * - Touch-friendly dropdown with adequate spacing
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // Mobile-first styles with adequate touch target size
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // Mobile-friendly item height and padding
