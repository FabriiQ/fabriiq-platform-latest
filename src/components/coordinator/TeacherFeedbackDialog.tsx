...
export function TeacherFeedbackDialog({
  ...
  // Create teacher feedback mutation
  const createTeacherFeedback = api.feedback.createTeacherFeedback.useMutation({
    onSuccess: () => {
      toast({
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Provide feedback for this teacher. This will be visible to the teacher and other coordinators.
          </DialogDescription>
        </DialogHeader>
