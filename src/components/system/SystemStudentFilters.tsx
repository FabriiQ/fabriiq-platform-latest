...
interface SystemStudentFiltersProps {
...
export function SystemStudentFilters({
  campuses,
  programs,
  currentCampusId,
  currentProgramId,
  ...
  const hasFilters = currentCampusId || currentProgramId || currentStatus || searchQuery;
