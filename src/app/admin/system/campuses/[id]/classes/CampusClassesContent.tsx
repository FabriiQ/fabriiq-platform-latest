...
import { ChevronLeft, Plus, Home, Users, Calendar, BookOpen } from "lucide-react";
...
export function CampusClassesContent({
  ...
  const uniqueCourses = Array.from(
    new Map(
      classes.map(cls => [
        cls.courseCampus.course.code,
        {
          id: cls.courseCampus.course.code, // Using code as ID for filtering
