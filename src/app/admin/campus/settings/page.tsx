...
export const metadata: Metadata = {
  title: "Campus Admin Settings",
  description: "Manage your campus administrator settings and preferences",
};

export default async function CampusAdminSettingsPage() {
  try {
    ...
    return (
      <div className="container mx-auto py-6 space-y-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Campus Administrator Settings</h1>
          <p className="text-muted-foreground">
            Manage your campus administrator settings and preferences
          </p>
        </div>
    ...
    logger.error("Error loading campus admin settings", { error });
    return (
