...
import { SubmissionGradingInterface } from '@/components/assessments/grading/SubmissionGradingInterface';
...
export default function SubmissionGradePage() {
  ...
  // Find the current submission index
  const currentSubmissionIndex = submissions.findIndex(s => s.id === submissionId);
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Grade Submission</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <SubmissionGradingInterface
        ...
        initialSubmissionIndex={currentSubmissionIndex}
      />
    </div>
  );
}
