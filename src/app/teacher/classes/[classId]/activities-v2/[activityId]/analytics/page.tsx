...
export default async function ActivityV2AnalyticsPageRoute({ params }: PageProps) {
  ...
  if (gradingConfig?.version !== '2.0') {
    // Redirect to legacy activity analytics
    return redirect(`/teacher/classes/${classId}/activities/${activityId}/analytics`);
  }
